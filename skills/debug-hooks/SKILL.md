...
description: "Debug Claude Code hooks (PreToolUse, PostToolUse, etc.). Use when hooks aren't firing or produce wrong output. Trigger with 'my hook isn't firing', 'why did the PreToolUse hook not run', 'the hook output is wrong'. Loaded by ai-maestro-plugin"
