...
- [../ama-trdd-transition/references/approval-tiers-and-zones.md](../ama-trdd-transition/references/approval-tiers-and-zones.md) — the four zones + `proposal → planned` lifecycle + the `min-approval-requirement:` ladder + batch-approval syntax.
