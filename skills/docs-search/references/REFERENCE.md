...
- Ensure AI Maestro is running — run `docs-stats.sh`; a clean exit (no connection error) means the server is reachable (no direct server call — decoupled per ai-maestro#11)
